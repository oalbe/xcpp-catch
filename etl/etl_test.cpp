...
TEST_CASE("Transforms one value", "[answer]") {
...
TEST_CASE("Transforms more values", "[answer]") {
...
TEST_CASE("Transforms more keys", "[answer]") {
...
TEST_CASE("Transforms a full dataset", "[answer]") {
